...
void ShaderProgram::draw(Drawable &d)
{
    ...
    if (d.bindVertData()) {
        ...
        context->glEnableVertexAttribArray(attrCol);
        context->glVertexAttribPointer(attrCol, 4, GL_FLOAT, false, 3*sizeof(glm::vec4), (const GLvoid*) (1*sizeof(glm::vec4)));
        context->glEnableVertexAttribArray(attrNor);
        context->glVertexAttribPointer(attrNor, 4, GL_FLOAT, false, 3*sizeof(glm::vec4), (const GLvoid*) (2*sizeof(glm::vec4)));
    }
