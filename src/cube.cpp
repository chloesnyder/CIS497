...
static const int CUB_IDX_COUNT = 8;//36;
static const int CUB_VERT_COUNT = 4;//24;
...
{
    int idx = 0;
    cub_vert_pos[idx++] = glm::vec4(0, 0, 0, 1);
    cub_vert_pos[idx++] = glm::vec4(512, 0, 0, 1);
    cub_vert_pos[idx++] = glm::vec4(512, 0, 512, 1);
    cub_vert_pos[idx++] = glm::vec4(0, 0, 512, 1);
}
...
void Cube::create()
{
    ...
    for(int i = 0; i < CUB_VERT_COUNT; i++){
        cub_vert_col[i] = glm::vec4(1, 1, 1, 1);//glm::vec4(0.2f, 1.0f, 0.6f, 1);
    }
